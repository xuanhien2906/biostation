  ...
  return (
    <div className="bg-[#f8f5f0] min-h-screen py-8 px-4 sm:px-6 lg:px-8 text-[#2d241e]" style={{ backgroundColor: 'var(--bg-tone, #f8f5f0)' }}>
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* MODAL: EDIT CHAO LUA ME ARTICLE */}
        ...
        {editingDish && (
          <div className="fixed inset-0 z-50 bg-[#2d241e]/70 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
            <div className="bg-white border border-[#e2d5c3] rounded-3xl max-w-xl w-full p-6 space-y-4 shadow-2xl relative max-h-[90vh] overflow-y-auto text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="font-semibold block mb-1">Giá Tiền (VNĐ) *</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="font-semibold block mb-1">Mã Màu Chữ / Nền (Tùy Chọn)</label>
                  <div className="flex gap-2 items-center">
                    <input
                      type="color"
                      value={editingDish.color || '#ea580c'}
                      onChange={(e) => setEditingDish({ ...editingDish, color: e.target.value })}
                      className="w-10 h-10 rounded cursor-pointer border-0 p-0 bg-transparent"
                    />
                    <input
                      type="text"
                      value={editingDish.color || ''}
                      onChange={(e) => setEditingDish({ ...editingDish, color: e.target.value })}
                      placeholder="#ea580c"
                      className="flex-1 p-2.5 rounded-xl border border-[#dcd0bf] bg-[#fbf8f3] uppercase"
                    />
                  </div>
                </div>
              </div>
