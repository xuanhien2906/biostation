...
export const PRODUCTS: Product[] = [
  // --- DỊCH VỤ BỮA ĂN TRẢI NGHIỆM TẠI BIO STATION ---
  {
    ...
    subtitle: 'Cơm Nhà Bách Mộc 100% Nguyên Liệu Sạch',
    ...
    keyBenefits: [
      ...
      'Phần ăn dinh dưỡng trọn vẹn với giá cực tốt',
  ...
  },
  {
    ...
    keyBenefits: [
      'Mức giá 100.000đ trọn gói cho 2 người',
